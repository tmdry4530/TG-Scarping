...
if TYPE_CHECKING:
    from ...tl.types import TypeInputMedia, TypeInputPrivacyRule, TypeInputUser, TypeMessageEntity, TypeReportReason
...
class EditStoryRequest(TLRequest):
    CONSTRUCTOR_ID = 0x2aae7a41
    SUBCLASS_OF_ID = 0x8af52aac

    # noinspection PyShadowingBuiltins
    def __init__(self, id: int, media: Optional['TypeInputMedia']=None, caption: Optional[str]=None, entities: Optional[List['TypeMessageEntity']]=None, privacy_rules: Optional[List['TypeInputPrivacyRule']]=None):
        """
    ...
    def _bytes(self):
        ...
        return b''.join((
            b'Az\xae*',
            struct.pack('<I', (0 if self.media is None or self.media is False else 1) | (0 if self.caption is None or self.caption is False else 2) | (0 if self.entities is None or self.entities is False else 2) | (0 if self.privacy_rules is None or self.privacy_rules is False else 4)),
    ...
    def from_reader(cls, reader):
        ...
        if flags & 4:
            ...
            _privacy_rules = None
        return cls(id=_id, media=_media, caption=_caption, entities=_entities, privacy_rules=_privacy_rules)
...
class GetStoryViewsListRequest(TLRequest):
    CONSTRUCTOR_ID = 0x4b3b5e97
    SUBCLASS_OF_ID = 0xb9437560

    # noinspection PyShadowingBuiltins
    def __init__(self, id: int, offset_date: Optional[datetime], offset_id: int, limit: int):
        """
    ...
    def from_reader(cls, reader):
        ...
        _limit = reader.read_int()
        return cls(id=_id, offset_date=_offset_date, offset_id=_offset_id, limit=_limit)
...
class SendStoryRequest(TLRequest):
    CONSTRUCTOR_ID = 0x424cd47a
    SUBCLASS_OF_ID = 0x8af52aac

    def __init__(self, media: 'TypeInputMedia', privacy_rules: List['TypeInputPrivacyRule'], pinned: Optional[bool]=None, noforwards: Optional[bool]=None, caption: Optional[str]=None, entities: Optional[List['TypeMessageEntity']]=None, random_id: int=None, period: Optional[int]=None):
        """
        :returns Updates: Instance of either UpdatesTooLong, UpdateShortMessage, UpdateShortChatMessage, UpdateShort, UpdatesCombined, Updates, UpdateShortSentMessage.
        """
        self.media = media
    ...
    def from_reader(cls, reader):
        ...
        if flags & 8:
            ...
            _period = None
        return cls(media=_media, privacy_rules=_privacy_rules, pinned=_pinned, noforwards=_noforwards, caption=_caption, entities=_entities, random_id=_random_id, period=_period)
